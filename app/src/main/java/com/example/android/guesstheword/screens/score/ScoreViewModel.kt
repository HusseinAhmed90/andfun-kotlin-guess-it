...
//  (01) Create the ScoreViewModel class and have it take in an integer constructor parameter
// called finalScore
//  (06) Add a LiveData for the score and the play again event, using the best practices for
